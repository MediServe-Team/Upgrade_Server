...
export const MAIL_RESET_PASSWORD_SUBJECT = '[MediServe reset password]';
  ...
  <body>
      <div class="container">
          ...
          <div class="wrap-button">
              <a href="${process.env.CLIENT_URL}/login" class="login-button">Login MediServe</a>
          </div>
      </div>
  </body>
  </html>
...
export const templateResetPassword = (name, token) => {
  ...
  <body>
      <div class="container">
          <h1>Hello ${name},</h1>
          <p>You have requested to reset your password for the <b style="color: rgb(244, 131, 61);">MediServe</b> system!</p>
          <hr/>
